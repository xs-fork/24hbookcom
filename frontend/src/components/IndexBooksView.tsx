...
import IndexBookDetailView from './IndexBookDetailCard';
import IndexBookCardList from './IndexBookCardList';
...
const IndexBooksView: React.FC<BooksViewProps> = ({ books, pagination, setPagination, pageCount }) => {
        ...
        <div>
          <MediaQuery minWidth={900}>
            <IndexBookCardList
              ...
              renderSubComponent={(row) => <IndexBookDetailView book={row.original} />}
